...
def main(parameters_list):
    ...
    def draw_scatter(x_training, y_training, x_predicting, y_predicting, error, add, R_value):
        ymin1 = 75
        ymax1 = 270
        ymin2 = 0
        ymax2 = 30
    ...
    def draw_relation_allRE_whole(x_predict, y_predict):
        ...
        ax1.scatter(x_predict[:, 0], y_predict[:, 0],
                    label='Predicted UTS', color='cornflowerblue')
        fitting_w_1, fitting_b_1 = linear_fitting(x_predict[0:154, 0],
                                                  y_predict[0:154, 0])
        ax1.plot(x_Al, fitting_w_1 * x_Al + fitting_b_1, color='red',
                 linestyle='dashed', label='w = %.2f  b = %.2f' % (fitting_w_1, fitting_b_1))
        ax1.legend(loc='upper right', frameon=False)
        # Si/UTS
        ax2.scatter(x_predict[:, 1], y_predict[:, 0],
                    label='Predicted UTS', color='cornflowerblue')
        fitting_w_2, fitting_b_2 = linear_fitting(x_predict[6:154, 1],
                                                  y_predict[6:154, 0])
        ax2.plot(x_Si, fitting_w_2 * x_Si + fitting_b_2, color='red',
                 linestyle='dashed', label='w = %.2f  b = %.2f' % (fitting_w_2, fitting_b_2))
        ax2.legend(loc='upper right', frameon=False)
        # AlSi2Sr/UTS
        ax3.scatter(x_predict[:, 2], y_predict[:, 0],
                    label='Predicted UTS', color='cornflowerblue')
        fitting_w_3, fitting_b_3 = linear_fitting(x_predict[0:154, 2],
                                                  y_predict[0:154, 0])
        ...
        ax4.scatter(x_predict[:, 0], y_predict[:, 1],
                    label='Predicted YS', color='chocolate')
        fitting_w_4, fitting_b_4 = linear_fitting(x_predict[0:154, 0],
                                                  y_predict[0:154, 1])
        ax4.plot(x_Al, fitting_w_4 * x_Al + fitting_b_4, color='red',
                 linestyle='dashed', label='w = %.2f  b = %.2f' % (fitting_w_4, fitting_b_4))
        ax4.legend(loc='upper right', frameon=False)
        # Si/YS
        ax5.scatter(x_predict[:, 1], y_predict[:, 1],
                    label='Predicted YS', color='chocolate')
        fitting_w_5, fitting_b_5 = linear_fitting(x_predict[6:154, 1],
                                                  y_predict[6:154, 1])
        ...
        # AlSi2Sr/YS
        ax6.scatter(x_predict[:, 2], y_predict[:, 1],
                    label='Predicted YS', color='chocolate')
        fitting_w_6, fitting_b_6 = linear_fitting(x_predict[0:154, 2],
                                                  y_predict[0:154, 1])
        ...
        ax7.scatter(x_predict[:, 0], y_predict[:, 2],
                    label='Predicted EL', color='mediumseagreen')
        fitting_w_7, fitting_b_7 = linear_fitting(x_predict[0:154, 0],
                                                  y_predict[0:154, 2])
        ...
        ax8.scatter(x_predict[:, 1], y_predict[:, 2],
                    label='Predicted EL', color='mediumseagreen')
        fitting_w_8, fitting_b_8 = linear_fitting(x_predict[6:154, 1],
                                                  y_predict[6:154, 2])
        ...
        ax9.scatter(x_predict[:, 2], y_predict[:, 2],
                    label='Predicted EL', color='mediumseagreen')
        fitting_w_9, fitting_b_9 = linear_fitting(x_predict[0:154, 2],
                                                  y_predict[0:154, 2])
